...
namespace behaviour_tree::editor
{
	...
	GraphNode* BehaviourTreeViewer::CreateGraphNode(int node_index, const Ref<Theme>& theme)
	{
		...
		gnode->connect("dragged", callable_mp(this, &BehaviourTreeViewer::OnNodeDrag), varray(node_index));
		...
		set_root->connect("pressed", callable_mp(this, &BehaviourTreeViewer::SetAsRoot), varray(node_index));
