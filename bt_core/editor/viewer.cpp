...
namespace behaviour_tree::editor
{
	...
	void BehaviourTreeViewer::InitializeGraph()
	{
		...
		save_tree->connect("pressed", callable_mp(this, &BehaviourTreeViewer::OnSaveBehaviourTree), { true });
		...
		compressed_tree->connect("pressed", callable_mp(this, &BehaviourTreeViewer::OnSaveBehaviourTree), { false });
	...
	void BehaviourTreeViewer::InitializeCreateNodesTree()
	{
		...
		m_NodesTextFilter->connect("gui_input", callable_mp(this, &BehaviourTreeViewer::OnNodeGUIInput), varray(m_NodesTree, m_NodesTextFilter));
	}
